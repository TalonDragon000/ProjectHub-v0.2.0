    ...
    <nav className="absolute bottom-0 w-full bg-surface border-t border-subtle pb-safe pt-2 px-8 flex justify-between items-center z-20 shadow-nav">
      ...
      <div className="relative -top-6">
        <button
          ...
          className={`w-14 h-14 rounded-full flex items-center justify-center text-inverted text-2xl border-4 border-surface transition-all duration-300 ${globalMenuOpen ? 'bg-overlay rotate-45 shadow-lg' : 'bg-gradient-to-br from-accent-primary to-accent-tertiary shadow-dock-btn active:scale-95'}`}
        >

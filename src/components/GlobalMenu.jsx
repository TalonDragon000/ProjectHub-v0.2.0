  ...
  return (
    <div className="absolute inset-0 bg-base/80 backdrop-blur-sm z-10 flex flex-col justify-end items-center pb-28 px-6 animate-in fade-in">
      <div className="space-y-4 w-full max-w-xs">
        <button
          onClick={() => openWizard()}
          className="w-full bg-surface border border-default text-white font-bold p-4 rounded-2xl flex items-center justify-center space-x-3 shadow-lg hover:border-accent-primary transition-colors"
        >
        ...
        <button
          ...
          className="w-full bg-surface border border-default text-white font-bold p-4 rounded-2xl flex items-center justify-center space-x-3 shadow-lg hover:border-accent-amber transition-colors"
        >
        ...
        <button
          ...
          className="w-full bg-surface border border-default text-white font-bold p-4 rounded-2xl flex items-center justify-center space-x-3 shadow-lg hover:border-accent-tertiary transition-colors"
        >
